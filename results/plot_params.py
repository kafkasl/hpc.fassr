...
# RF
plot_by_estimators(rf, 'Number of trees', 'estimators', 'rf_estimators_%s' % exp)
# Ada
plot_by_estimators(ada, 'Number of estimators', 'estimators', 'ada_estimators_%s' % exp)
# Neural nets
plot_by_estimators(mlp, 'Number of neurons', 'size', 'mlp_size_%s' % exp)
plot_by_estimators(mlp, 'Solver', 'solver', 'mlp_solver_%s' % exp)
plot_by_estimators(mlp, 'Activation function', 'activation', 'mlp_activation_%s' % exp)
# SVM
# TOO FEW VALUES:
